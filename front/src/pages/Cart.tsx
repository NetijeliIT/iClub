                ...
                <div className="w-full">
                    ...
                    {meals.length === 0 ? (
                        <div className="text-center text-xl sm:text-2xl md:text-3xl text-gray-800 flex flex-col items-center mt-4" style={{ fontFamily: 'Caveat, cursive' }}>
                            <svg className="w-50 h-50 fill-[#708238]" xmlns="http://www.w3.org/2000/svg" version="1.0" width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
            ...
            {meals.length > 0 && (
                <>
                    <div className="my-4 sm:my-6 md:my-8">
                        <h4 className="text-lg text-gray-700 font-medium">Write time and anything you want:</h4>
                        <div className="border border-[#708238] rounded">
                    ...
                    <button
                        onClick={handleOrder}
                        className="bg-[#708238] text-white text-lg font-medium p-2 px-6 rounded float-right cursor-pointer hover:opacity-90 transition-all duration-150"
                    >
                        Order
                    </button>
                </>
